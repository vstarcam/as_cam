...
//            }
    ...
    private void setTagResult(SetTagCmdMessage setTagCmdMsg) {
        ...
        Log.print( "settag result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    }
    ...
    private void bindAliasResult(BindAliasCmdMessage bindAliasCmdMessage) {
        ...
        Log.print( "bindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    ...
    private void unbindAliasResult(UnBindAliasCmdMessage unBindAliasCmdMessage) {
        ...
        Log.print("unbindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
